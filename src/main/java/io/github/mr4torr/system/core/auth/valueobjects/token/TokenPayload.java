...
public class TokenPayload implements TokenPayloadContract {
    private final String id;
    private final String sessionId;

    public TokenPayload(String id, String sessionId) {
        this.id = id;
    ...
    public Map<String, String> toArray() {
        ...
        results.put("resource", TokenEnum.AUTHORIZATION.toString());
        return results;
    }
